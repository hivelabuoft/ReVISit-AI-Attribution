...
Each participant in the ai-attribution study sees **5 out of 102 vignettes**. The assignment is **balanced** — the system always picks the 5 least-shown vignettes so that all 102 get roughly equal exposure over time.
...
2. **Balanced assignment**: The system maintains a count of how many times each vignette (1–102) has been assigned. When a new participant arrives:
...
- **Counts grid** — all 102 vignettes with their assignment count. Green = lowest count, red = highest count.
